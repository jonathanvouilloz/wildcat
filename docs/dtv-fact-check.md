...
| 11 | Apply depuis l'étranger uniquement, pas depuis la Thaïlande (`dtv_apply_step1_b`, `dtv_apply_mistake1`, `dtv_faqp_a14`, `dtv_mt_tbl_apply_dtv`) | ✅ **MàJ 2026-09-14** | Toujours hors Thaïlande, **et depuis le 31/08/2026 uniquement auprès de la mission couvrant le pays de nationalité ou de résidence légale** (fin des dépôts en pays tiers type Vientiane). Nuance : l'ambassade de Vientiane écrit « permanent resident », ISSA Compass rapporte que titres de séjour longue durée / permis de travail sont acceptés. Dossiers déposés avant le 31/08 : anciennes règles | Ambassade royale de Thaïlande à Vientiane (27/08/2026), ISSA Compass (MàJ 14/09/2026) | Appliqué au silo le 2026-09-14 |
| 11b | **Certificat de casier judiciaire requis** (`dtv_elig_glance2_b`, `dtv_elig_who_age_b`, `dtv_apply_step4_b`, `dtv_apply_doc_criminal`) | ✅ **ajout 2026-09-14** | Depuis le 31/08/2026, émis par le pays de nationalité ou de résidence. Format, validité, traduction/légalisation non précisés officiellement | Ambassade de Vientiane, ISSA Compass | Appliqué au silo le 2026-09-14 |
...
| 15 | Autres soft power : cuisine thaï, médical, sport, festivals (`dtv_faqp_a4`) | ⚠️ **À nuancer (mise à jour 2026-07-03)** | Liste 2025-2026 confirmée par 2 sources indépendantes datées (The Thaiger + ExpatDen, consultées 2026-07-03, via `/seo-sources` sur l'article `cheapest-dtv-soft-power-activity`) : Muay Thai, cuisine thaï, traitement médical, séminaires, événements artistiques. **Les écoles de langue thaïe généralistes ont été retirées de la liste officielle qualifiante en 2025** — les candidats sont désormais redirigés vers le visa Non-Immigrant ED pour ce cas d'usage. Le silo `/dtv-visa` (pages `dtv_faqp_a4` etc.) ne mentionne pas les écoles de langue donc n'est pas en contradiction, mais **ne pas réintroduire "langue/language school" comme option soft power DTV valide** dans du contenu futur sans revérifier. | ExpatDen (liste), The Thaiger + ExpatDen (retrait langue, 2026-07-03) | Si un futur contenu mentionne les écoles de langue comme option DTV, corriger en la présentant explicitement comme option historique retirée en 2025, jamais comme option actuelle. |
...
5. **Règle des 6 mois (Muay Thai)** — c'est une **pratique d'approbation**, pas un texte légal publié. Solide en 2025-2026 mais pourrait être codifiée ou assouplie. Le site la présente comme pratique constatée, ce qui est la bonne posture.
   - **Mise à jour 2026-09-24** : durcissement rapporté. Forfaits de 1 à 3 mois « visa only » de plus en plus refusés ; 6 mois décrits comme « bare minimum », 9 mois+ attendus par certaines missions, 1 an rapporté pour Dhaka ; dates du cours alignées sur le séjour (petchnumnoi, maj 04/08/2026). **Source non officielle** → formulé comme pratique rapportée dans `cheapest-dtv-soft-power-activity` (section « Update, September 2026 »). À confirmer avec les dossiers réels des élèves de Meaw.
7. **Preuve de fonds à l'arrivée (ajout 2026-09-24)** — distincte des 500 000 THB DTV : 10 000 / 20 000 THB par personne selon l'entrée (famille ×2, < 12 ans exemptés), annonce du ministère de l'Intérieur de 1980 (montants 2000), refus d'entrée possible au titre de la section 12(2) de l'Immigration Act. Rappel TAT du 06/07/2026 et repris avec les règles du 15/09/2026, **pas une mesure nouvelle**. Le DTV n'est pas nommé dans le barème : le site recommande prudemment 20 000 THB (`dtv-visa-proof-of-funds`).
