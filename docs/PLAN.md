...
9. ▶️ **Reprise — ce qu'il manque (état au 2026-06-05 soir)** :
...
10. Données réelles manquantes : email (`src/config/site.ts`) — `TODO(real data)` ; ~~horaires~~ (✅ planning réel du flyer committé 2026-06-05, `site.schedule` + DaySchedule) ; détail packages séjour + condos Meaw (`structure-stay.md` §0 9b/9c). Redirect `/muay-thai-training` → `/stay-train` (E7/E10). ~~Pillar FR : title/meta à raccourcir~~ (réglé par le re-cadrage E5c — title 50ch / meta 143ch).
