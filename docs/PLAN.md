...
10. ▶️ **Reprise — ce qu'il manque (état au 2026-06-05 soir)** :
   - **Avec Meaw (faits, non bloquants — copy écrite pour ne pas en dépendre)** : détail exact "what's included" des packages week/month/fighter (`structure-stay.md` §0 9b) · condos (prix, nombre, distance du camp) · âge mini kids (~6 ans estimé) · PDF checklist MFA (fact-check DTV)
