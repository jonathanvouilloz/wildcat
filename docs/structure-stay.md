...
| ~~❌~~ ✅ `/stay-train/scooter-rental` | **Verdict renversé — créé 2026-06-05** | "scooter rental chiang mai" 210/mo · diff 24 LOW. Le verdict initial ("SERP = loueurs locaux, hors silo") supposait que Wildcat n'était pas loueur — faux : **Meaw loue réellement** (Scoopy i Prestige 2024 350/j · 3000/mois + Click). Intent redevenu gagnable en local (Hang Dong/Nong Kwai, zéro camp positionné) | — | Satellite : flotte CMS (collection Sanity `scooter`, toggle dispo) + Service JSON-LD. Pas de FAQPage (porteur = pillar). Conditions exactes en attente → `docs/checklist.md` §D |
