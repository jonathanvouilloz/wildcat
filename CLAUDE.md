...
**Phase : E1→E5 complets + satellites DTV (E5b) + silo Train (E5c) + fighters guest book (E5d) + silo About (E5e). Prochain : hero home, contenu studio, vérif faits [À VÉRIFIER] (DTV + Train), puis E6 (DTV app) ou satellites Stay & Train.**
...
- [ ] Prochain : saisir le vrai contenu dans le studio (coaches/schedule/testimonials/**fighters du livre d'or**) ; corriger les faits DTV selon `docs/dtv-fact-check.md` ; **Instagram feed** (composant réutilisable sur base `CommunityGallery`) ; puis **E6 DTV app** ou satellites Stay & Train (batch 2 + re-ciblage FR "camp/stage")
