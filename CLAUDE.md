...
**Phase : E1→E5 complets (thème + i18n + Sanity + pages prioritaires). Prochain : contenu studio, puis E6 (DTV app) ou satellites E5.**
...
- [ ] Questions ouvertes : **Q1** storage DTV (avant E6), **Q5** domaine. Env prod à poser : `RESEND_API_KEY`, `CONTACT_EMAIL`. Redirect `/muay-thai-training` → `/stay-train` (E7/E10)
- [ ] Prochain : saisir le vrai contenu dans le studio (coaches/schedule/testimonials/fighters) ; puis **E6 DTV app** ou satellites E5
